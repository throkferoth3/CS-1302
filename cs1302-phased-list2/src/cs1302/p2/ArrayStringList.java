...
public class ArrayStringList extends BaseStringList {
     ...
     * supplied Stringlist into an array.
     *
     * @param other This is the StringList to be copied.
     * @throws NullPointerException If you put a null StringList.
     */
    ...
    /**
     * This returns the list of the items from the start of the array list
     * and jumps the distance of step until it reaches or goes past stop.
     * Inherits param, return, and/or exception comments.
     *
     * <p>
     * {@inheritDoc}
    ...
    public FancyStringList slice(int start, int stop, int step) {
        ...
        FancyStringList returnValue = new ArrayStringList();
        int counter = 0;
        for (int i = start; i < stop; i++) {
            if (start + counter * step < stop) {
                returnValue.append(items[start + counter * step]);
            }
            counter++;
        }
        return returnValue;
    ...
    /**
     * This returns the array list of the items in reverse order.
     * Inherits param, return, and/or exception comments.
     *
     * <p>
     * {@inheritDoc}
